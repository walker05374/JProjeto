# Generated by Django 4.2.4 on 2025-04-14 13:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posto_selecionado', models.CharField(max_length=255)),
                ('endereco_posto', models.CharField(max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='PostoSaude',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('outro_exame', models.CharField(blank=True, max_length=255, null=True)),
                ('observacao', models.TextField(blank=True, null=True)),
                ('status', models.CharField(default='Aguardando Resposta', max_length=20)),
                ('exame', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='meuapp.exame')),
                ('nome_cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('posto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='meuapp.postosaude')),
            ],
        ),
    ]
